const PricingSection1Preview = () => {
  return <>
    <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-20 grid-cols-1 place-items-center m-5">
...
export default PricingSection1Preview